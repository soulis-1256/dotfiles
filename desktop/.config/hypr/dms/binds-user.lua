...
hl.unbind("ALT + XF86Launch1")
hl.bind("ALT + XF86Launch1", hl.dsp.exec_cmd("grimblast copy active"), { description = "Screenshot window" })
hl.unbind("CTRL + XF86Launch1")
hl.bind("CTRL + XF86Launch1", hl.dsp.exec_cmd("grimblast copy screen"), { description = "Screenshot screen" })
hl.unbind("SUPER + T")
hl.bind("SUPER + T", hl.dsp.exec_cmd("ghostty"), { description = "Terminal (ghostty)" })
hl.unbind("XF86Launch1")
hl.bind("XF86Launch1", hl.dsp.exec_cmd("grimblast copy area"), { description = "Screenshot area" })
