...
Item {
    ...
    IpcHandler {
        function open(): string {
            const bar = root.getPreferredBar("launcherButtonRef") || root.getPreferredBar();
            if (bar && bar.launcherButtonRef && typeof bar.launcherButtonRef.openWithMode === "function") {
                bar.launcherButtonRef.openWithMode("all");
        ...
        function toggle(): string {
            const bar = root.getPreferredBar("launcherButtonRef") || root.getPreferredBar();
            if (bar && typeof bar.triggerLauncher === "function") {
                bar.triggerLauncher();
        ...
        function openWith(mode: string): string {
            ...
            const bar = root.getPreferredBar("launcherButtonRef") || root.getPreferredBar();
            if (bar && bar.launcherButtonRef && typeof bar.launcherButtonRef.openWithMode === "function") {
                bar.launcherButtonRef.openWithMode(mode);
        ...
        function toggleWith(mode: string): string {
            ...
            const bar = root.getPreferredBar("launcherButtonRef") || root.getPreferredBar();
            if (bar && bar.launcherButtonRef && typeof bar.launcherButtonRef.toggleWithMode === "function") {
                bar.launcherButtonRef.toggleWithMode(mode);
