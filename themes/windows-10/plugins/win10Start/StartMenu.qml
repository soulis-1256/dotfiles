...
Item {
    ...
    function createFolderWithTile(tile, folderName) {
        ...
        root.group1Tiles = packTilesGrid(r1.list);
        root.group2Tiles = packTilesGrid(r2.list);
        saveTilesState();
    }
    ...
    function addTileToFolder(tile, folderId) {
        ...
        root.group1Tiles = packTilesGrid(PinGrid.addTileToFolder(root.group1Tiles, tile, folderId));
        root.group2Tiles = packTilesGrid(PinGrid.addTileToFolder(root.group2Tiles, tile, folderId));
        saveTilesState();
    }
