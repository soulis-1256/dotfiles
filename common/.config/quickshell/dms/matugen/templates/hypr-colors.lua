...
-- Consumed by hyprbars after the plugin loads (hl.config plugin keys are a no-op before that).
_G.dms_hyprbars = {
	bar_color = "rgba({{colors.surface_container.default.hex_stripped}}cc)",
